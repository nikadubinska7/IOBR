...
The latest Windows build is published on GitHub Releases:

1. Open the repository on GitHub.
2. Go to `Releases`.
3. Open `Latest Windows Build`.
4. Download `iOBR-Extractor-Windows.zip`.
...
Download path from GitHub Actions:
